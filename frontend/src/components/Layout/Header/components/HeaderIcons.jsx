...
const HeaderIcons = ({ isMenuOpen, setIsMenuOpen, toggleSearch }) => {
  ...
  return (
    <div className="flex items-center gap-5">
      {/* Search Icon */}
      <button onClick={toggleSearch} className="text-primary hover:text-gray-300">
        <Search size={24} />
      </button>

      {/* Cart Icon with Counter */}
      <button onClick={handleCartClick} className="text-primary hover:text-gray-300 relative">
      ...
      {user ? (
        ...
        <button
          className="text-primary hover:text-gray-300 hidden lg:block"
      ...
      <button
        ...
        className="lg:hidden text-primary hover:text-gray-300"
      >
